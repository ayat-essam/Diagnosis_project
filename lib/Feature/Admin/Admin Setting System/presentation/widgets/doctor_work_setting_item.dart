import 'package:diagnosis_project/Feature/Admin/Admin%20Setting%20System/presentation/widgets/input_field.dart' show InputField;
  ...
  Widget build(BuildContext context) {
    return SettingsCard(
      ...
      icon: SvgPicture.asset(
        ...
        height: 25,
        colorFilter:
            const ColorFilter.mode(AppColors.BluePrimary, BlendMode.srcIn),
      ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            CustomText(
                text: 'Set standard working hours for doctor availability',
                fontSize: 12.sp,
