          ...
          cells: [
            ...
            DataCell(IconButton(
              onPressed: () {
                ...
                final patientsCubit = context.read<PatientsMangementCubit>();

                showDialog(
                  context: context,
                  builder: (context) => BlocProvider.value(
                    value: patientsCubit, // Provide the existing cubit instance
                    child: ActionPatientDialog(patientEntity: patient),
                  ),
                );
              },
              icon: const Icon(
