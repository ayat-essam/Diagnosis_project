       ...
       BlocBuilder<AddDoctorCubit, AddDoctorState>(
          builder: (context, state) {
            return RadioGroup<String>(
              ...
              child: Row(
                children: [
                  const Radio<String>(value: 'Male',activeColor: AppColors.BluePrimary),
                  Text('Male', style:StyleApp.font12BlackSemiBold.copyWith(color: AppColors.grayDark)),
                  Gap(8.w),
                  const Radio<String>(value: 'Female',activeColor: AppColors.BluePrimary),
                  Text('Female', style: StyleApp.font12BlackSemiBold.copyWith(color: AppColors.grayDark),),
                ],
              ),
            );
          },
